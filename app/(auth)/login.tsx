    ...
    <ScreenBackground>
      <Container>
        ...
        <View className="mt-5">
          ...
          >
            <Text
              className={`text-[#9BBABB] font-lexendMedium text-[0.875rem] text-center ${login.isPending ? "opacity-50" : ""}`}
            >
              Forgot Password?
            </Text>
          </Pressable>
        ...
        <View className="mt-10 px-10 mb-9">
          <View className="flex-row gap-2 items-center justify-center mt-6">
            ...
            >
              <Text
                className={`text-[#00AEB5] font-lexendBold text-[1rem] ${login.isPending ? "opacity-50" : ""}`}
              >
                Create an account
              </Text>
            </TouchableOpacity>
